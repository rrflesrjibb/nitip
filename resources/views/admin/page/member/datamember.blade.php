...
<div class="container">
  <div class="row justify-content-center align-items-center" style="height: 95vh;">
       <div class="col-lg-10">
        <div class="card mx-auto float-right" style="max-width: 100%;">
                               ...
                               @if(isset($data_member) && count($data_member) > 0)
                                   ...
                                   @foreach ($data_member as $row)
                                       <tr>
                                           ...
                                           {{-- <td><center>
                                            <a href="#modalEdit{{ $row->id }}" data-toggle="modal" class="btn btn-primary"><i class="mdi mdi-pencil"></i></a>
                                            <a href="#modalHapus{{ $row->id }}" data-toggle="modal" class="btn btn-danger"><i class="mdi mdi-delete"></i></a></center>
                                        </td> --}}
                                       </tr>
                                   @endforeach
                               @endif
